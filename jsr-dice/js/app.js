...
var dice1 = document.getElementById('first-die');
var dice2 = document.getElementById('second-die');
dice1.className = firstDie
dice2.className = secondDie
}

var die = document.getElementById('roll-dice')
die.onclick = diceRoll;
